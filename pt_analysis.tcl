...
##	+----------------------------------------------------------------
##	| 	Copyright 2014 DAUIN - EDA GROUP							|
##	+----------------------------------------------------------------
...
# SLACK CONDITION
report_timing -delay_type min -slack_greater_than 0.2 -max_paths 2
report_timing -delay_type max -slack_greater_than 0.003 -max_paths 2
...
#exec cp ./saved/aes_cipher_top/post_synthesis_sim/aes_inv_cipher_top.v .
